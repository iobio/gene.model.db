java -classpath target/geneModelGffImporter-0.0.1-SNAPSHOT.jar:sqlite-jdbc-3.8.11.2.jar geneModelGffImporter.App gencode GRCh37 ./data/gencode/gencode.v41lift37.annotation.gff3
